...
public class MainActivity extends AppCompatActivity {
    ...
    // TODOne (1) Declare and instantiate an ArrayList of Strings called mLifecycleCallbacks
    // Must make static in order for to see onDestroy and onStop
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODOne (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        int listSize = mLifecycleCallbacks.size();
        for (int i = listSize - 1; i > -1; i--) {
            mLifecycleDisplay.append(mLifecycleCallbacks.get(i) + '\n');
        }

        // TODOne (5) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // TODOne (2) Add the ON_STOP String to the front of mLifecycleCallbacks
        // 0 adds String to the front of the ArrayList
    ...
    protected void onDestroy() {
        ...
        // TODOne (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
