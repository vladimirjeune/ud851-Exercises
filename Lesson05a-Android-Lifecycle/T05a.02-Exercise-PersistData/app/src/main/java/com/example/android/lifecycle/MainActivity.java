...
public class MainActivity extends AppCompatActivity {
    ...
    // TODOne (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODOne (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY) != false) {
    ...
    // TODOne (2) Override onSaveInstanceState
    @Override
    protected void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        // Do steps 3 - 5 within onSaveInstanceState
        // TODOne (3) Call super.onSaveInstanceState
        // TODOne (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
        // TODOne (5) Put the text from the TextView in the outState bundle

        logAndAppend(ON_SAVE_INSTANCE_STATE);
        String tvText = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, tvText);
