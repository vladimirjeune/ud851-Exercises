...
public class NotificationUtils {
    private static final int MAIN_PENDING_INTENT_ID = 1764;
    private static final int DRINK_NOTIFICATION_ID = 1864;
    ...
    public static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent
                .getActivity(context, MAIN_PENDING_INTENT_ID, mainIntent
