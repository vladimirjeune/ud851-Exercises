...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // TODOne (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String url = "https://www.udacity.com”/";

        // TODOne (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
        openWebPage(url);
    }
    ...
    // TODOne (1) Create a method called openWebPage that accepts a String as a parameter
    public void openWebPage(String aUrl) {
        // Do steps 2 - 4 within openWebPage

        // TODOne (2) Use Uri.parse to parse the String into a Uri
        Uri uri = Uri.parse(aUrl);

        // TODOne (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
