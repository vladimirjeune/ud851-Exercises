    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODOne (1) Store ChildActivity.class in a Class object called destinationActivity
                Class destinationActivity = ChildActivity.class;

                // TODOne (2) Create an Intent to start ChildActivity
                Intent childActivityIntent = new Intent(context, destinationActivity);

                // TODOne (3) Replace the Toast with code to start ChildActivity
